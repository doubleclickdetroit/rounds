...
describe BlacklistEntriesController do
  ...
  describe "POST 'create'" do
    ...
    it 'should throw a 404 if there is no equivalent to blocked_user_id' do
    ...
    context 'blocking by provider/uid' do
      it "should create a BlacklistEntry" do
        ...
        expect {
          post 'create', {:provider => auth.provider, :uid => auth.uid}, valid_session 
        }.to change(BlacklistEntry, :count).by(1)
      end
    end
  end
  ...
  describe "DELETE 'destroy'" do
    ...
    it 'should throw a 404 if there is no round_id' do
    ...
    context 'unblocking by provider/uid' do
      it "should destroy a BlacklistEntry" do
        ...
        expect {
          delete :destroy, {:provider => auth.provider, :uid => auth.uid}, valid_session 
        }.to change(BlacklistEntry, :count).by(-1)
      end
    end
  end
